...
def main(spark, userID, file_size):
    ...
    if file_size == 'small':
        ...
        val.select('user_id', 'recording_msid', 'count').write.parquet(f'hdfs:/user/{userID}/recommender_val_small')
        train.select('user_id', 'recording_msid', 'count').write.parquet(f'hdfs:/user/{userID}/recommender_train_small')

    elif file_size == 'full':

        val.select('user_id', 'recording_msid', 'count').write.parquet(f'hdfs:/user/{userID}/recommender_val')
        train.select('user_id', 'recording_msid', 'count').write.parquet(f'hdfs:/user/{userID}/recommender_train')
